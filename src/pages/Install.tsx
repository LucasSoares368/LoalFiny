        ...
        <Card className="w-full max-w-sm text-center">
          <CardHeader className="pb-3 pt-5">
            <div className="mx-auto mb-3">
              <h1 className="text-2xl font-bold text-primary">LocalFiny</h1>
            </div>
    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="sticky top-0 z-50 bg-background/80 backdrop-blur-md border-b border-border">
        <div className="container mx-auto px-3 py-3">
          <div className="flex items-center gap-3">
            ...
            <span className="font-bold text-lg text-primary">LocalFiny</span>
          </div>
        </div>
      </header>
      ...
      <main className="container mx-auto px-3 py-5 max-w-lg">
        ...
        <div className="text-center mb-5">
          ...
          <h1 className="text-2xl font-bold mb-1.5">Instale o LocalFiny</h1>
