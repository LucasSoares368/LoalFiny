      ...
      <SidebarHeader className="border-b border-sidebar-border px-4 group-data-[collapsible=icon]:px-0 h-14 flex items-center shrink-0">
        ...
        >
          <img
            src="/brand/icon.png"
            alt="LocalFiny"
            className="hidden h-9 w-9 rounded-xl object-contain group-data-[collapsible=icon]:block group-data-[collapsible=icon]:h-8 group-data-[collapsible=icon]:w-8"
          />
          <img
            src="/brand/logo.png"
            alt="LocalFiny"
            className="h-10 w-auto max-w-[170px] object-contain dark:hidden group-data-[collapsible=icon]:hidden"
          />
          <img
            src="/brand/logo-dark.png"
            alt="LocalFiny"
            className="hidden h-10 w-auto max-w-[170px] object-contain dark:block group-data-[collapsible=icon]:hidden"
          />
        </div>
      </SidebarHeader>
