        ...
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                ...
                <DialogDescription>Disponível no plano {planName}</DialogDescription>
              </div>
            </div>
          </DialogHeader>
          <div className="space-y-4">
            <p className="text-sm text-muted-foreground">
              {description ||
                `Este recurso está disponível no plano ${planName}. Faça upgrade para desbloquear todas as funcionalidades.`}
            </p>
  ...
  if (variant === "inline") {
    return (
      <div className="flex items-center gap-2 text-sm text-muted-foreground">
        ...
        <span>
          {feature} disponível no plano {planName}
        </span>
