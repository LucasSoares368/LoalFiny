...
const testimonials = [
  {
    ...
    content: "A LocalFiny reestruturou minha relação com o dinheiro. Hoje tenho clareza absoluta sobre minhas margens e consigo planejar o crescimento do meu negócio com segurança.",
    rating: 5
  },
  {
    name: "Ricardo Mendes",
