...
const faqs = [
  {
    question: "O que é o LocalFiny?",
    answer:
      "A LocalFiny é um ecossistema inteligente de gestão financeira. Nosso objetivo é dar ferramentas práticas para que qualquer pessoa ou pequeno empreendedor consiga dominar seu fluxo de caixa e atingir a liberdade financeira com tecnologia de ponta.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Nosso suporte está disponível via e-mail (contato@localfiny.com) e WhatsApp para assinantes dos planos Premium. Respondemos a todas as dúvidas em até 24 horas úteis.",
  },
  {
        ...
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-16 space-y-4">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              Tudo o que você precisa saber sobre como o LocalFiny funciona.
            </p>
          </div>
