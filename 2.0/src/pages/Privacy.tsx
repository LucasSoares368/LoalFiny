    ...
    <LegalLayout title="Política de Privacidade">
      <section className="space-y-6">
        ...
        <div>
          ...
          <p>
            O Financeiro Pro valoriza a sua privacidade. Esta Política de Privacidade explica como coletamos, usamos, protegemos e compartilhamos suas informações pessoais ao utilizar nossa plataforma.
          </p>
        </div>
        ...
        <div className="pt-8 border-t">
          <p>
            Para questões relacionadas à privacidade, entre em contato pelo email: contato@financeiropro.com.br
          </p>
        </div>
      </section>
    </LegalLayout>
