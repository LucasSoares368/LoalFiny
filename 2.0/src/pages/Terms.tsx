    ...
    <LegalLayout title="Termos de Serviço">
      <section className="space-y-6">
        ...
        <div>
          ...
          <p>
            Ao acessar e usar o Financeiro Pro ("Nós", "Nosso", "Plataforma"), você concorda em cumprir e estar vinculado a estes Termos de Serviço. Se você não concordar com qualquer parte destes termos, você não poderá acessar o serviço.
          </p>
        </div>
        ...
        <div>
          ...
          <p>
            O Financeiro Pro é uma plataforma de gestão financeira pessoal que oferece ferramentas para controle de transações, orçamentos, investimentos e análise de dados financeiros.
          </p>
        </div>
        ...
        <div>
          ...
          <p>
            Algumas funcionalidades do Financeiro Pro são oferecidas mediante assinatura.
          </p>
          <ul className="list-disc pl-6 mt-2 space-y-1">
        ...
        <div>
          ...
          <p>
            Todo o conteúdo da plataforma, incluindo logotipos, design, textos, gráficos e software, é de propriedade exclusiva do Financeiro Pro ou de seus licenciadores e está protegido por leis de direitos autorais.
          </p>
        </div>
        ...
        <div>
          ...
          <p>
            O Financeiro Pro fornece ferramentas de auxílio financeiro, mas não oferece consultoria financeira, jurídica ou contábil profissional. As decisões tomadas com base nas informações da plataforma são de sua inteira responsabilidade.
          </p>
          <p className="mt-2">
        ...
        <div className="pt-8 border-t">
          <p>
            Se você tiver dúvidas sobre estes Termos, entre em contato conosco através do email contato@financeiropro.com.br.
          </p>
        </div>
      </section>
    </LegalLayout>
