        ...
        <Card className="w-full max-w-sm text-center">
          <CardHeader className="pb-3 pt-5">
            <div className="mx-auto mb-3">
              <h1 className="text-2xl font-bold text-primary">Financeiro Pro</h1>
            </div>
            ...
            <CardDescription className="text-sm">
              A Financeiro Pro já está na sua tela inicial. Acesse como qualquer app!
            </CardDescription>
          </CardHeader>
      ...
      <header className="sticky top-0 z-50 bg-background/80 backdrop-blur-md border-b border-border">
        <div className="container mx-auto px-3 py-3">
          <div className="flex items-center gap-3">
            ...
            <span className="font-bold text-lg text-primary">Financeiro Pro</span>
          </div>
        </div>
      </header>
      ...
      <main className="container mx-auto px-3 py-5 max-w-lg">
        ...
        <div className="text-center mb-5">
          <div className="flex justify-center mb-3">
            <img 
              src={appIcon} 
              alt="Financeiro Pro App" 
              className="h-20 w-20 rounded-xl shadow-lg"
            />
          </div>
          <h1 className="text-2xl font-bold mb-1.5">Instale o Financeiro Pro</h1>
