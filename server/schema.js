...
export const TABLE_COLUMNS = {
  ...
  emergency_goals: ["created_at", "current_amount", "goal_type", "id", "profile_type", "target_amount", "target_months", "updated_at", "user_id"],
  evolution_api_config: ["api_key", "api_url", "created_at", "id", "instance_name", "updated_at"],
  fixed_costs: ["amount", "category_id", "created_at", "id", "is_variable", "name", "profile_type", "updated_at", "user_id"],
  ...
  plans: [
    ...
    "ai_enabled", "created_at", "description", "export_enabled", "features", "history_months", "id", "import_enabled", "is_active", "max_banks",
