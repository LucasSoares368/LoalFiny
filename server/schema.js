...
export const TABLE_COLUMNS = {
  ...
  custom_goals: ["category", "color", "completed_at", "created_at", "current_amount", "deadline", "description", "icon", "id", "is_completed", "name", "profile_type", "target_amount", "updated_at", "user_id"],
